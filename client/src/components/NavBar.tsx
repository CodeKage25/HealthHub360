          ...
          <div className="flex pt-24 flex-col justify-between items-center gap-8">
            ...
            <div>
              <Button
                onClick={() => {}}
                styles={
                  'flex items-center w-[141px] justify-center pt-4 pb-4 font-satoshi text-base font-medium not-italic rounded-lg bg-blue gap-2 tracking-lesstight text-white hover:bg-regal-blue'
                }
                type={'button'}
                title={'Get Started'}
                disabled={false}
