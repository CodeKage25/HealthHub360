...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 3367, 23)), "/Users/user/Downloads/carefinder/client/src/app/page.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7412))).default(props))],
    apple: [],
    openGraph: [],
    twitter: [],
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4180)), "/Users/user/Downloads/carefinder/client/src/app/layout.tsx"],
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6624)), "/Users/user/Downloads/carefinder/client/src/app/loading.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7412))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/user/Downloads/carefinder/client/src/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3497))
...
;// CONCATENATED MODULE: ./src/app/home/page.tsx
...
;// CONCATENATED MODULE: ./src/design-system/Button/Button.tsx
...
module.exports = createProxy("/Users/user/Downloads/carefinder/client/src/app/page.tsx");
...
var __webpack_exports__ = __webpack_require__.X(0, [859,157,609], () => (__webpack_exec__(1182)));
